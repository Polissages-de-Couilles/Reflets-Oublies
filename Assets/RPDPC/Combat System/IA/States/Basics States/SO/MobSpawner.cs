...
public class MobSpawner : StateBase
{
    ...
    public override StateEntityBase PrepareEntityInstance()
    {
        ...
        mse.Init(false, null, null, false, new Vector3(), 0, false, false, new Vector2(), monsterPrefab, nbToSpawnAtStart, mobMaxNb, spawnRange, rangeTimeBetweenSpawns, 0, null, false);
        return mse;
    }
}
